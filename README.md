...
4) Hit `Enter` TWO times
5) Copy output string and insert into API testing tool which will automaticaly pin parameters to request![nodejs](https://user-images.githubusercontent.com/37748474/110335835-543f7900-8035-11eb-84de-a10c34fd803e.png)
...
4) Copy this code and run in your Browser console or other js interpreter![success](https://user-images.githubusercontent.com/37748474/110335058-856b7980-8034-11eb-80a4-49b0e6c5cf1f.png)
5) Copy output string and insert into API testing tool (Postman, Insomnia, etc.) which will automaticaly pin parameters to request![postman](https://user-images.githubusercontent.com/37748474/110335285-bba8f900-8034-11eb-963a-fa7a2cefa092.png)
